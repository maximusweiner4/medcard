...
const styles = StyleSheet.create({
  ...
  brandName: { fontSize: 15, color: '#64748b' },
  doseText: { fontSize: 15, color: '#475569', marginTop: 2 },
  indicationText: { fontSize: 15, color: '#0d9488', fontStyle: 'italic', marginTop: 2 },
  freqChip: { backgroundColor: '#ccfbf1', borderRadius: 999, paddingHorizontal: 8, paddingVertical: 2, alignSelf: 'flex-start', marginTop: 6 },
  freqText: { color: '#0f766e', fontSize: 16, fontWeight: '600' },
